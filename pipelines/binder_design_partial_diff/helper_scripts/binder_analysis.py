...
metric_columns = ['ddg', 'rg', 'charge', 'sap', 'dG', 'dSASA', 'dG_dSASA_ratio', 'int_unsat_hbonds', 'int_hbonds', 'hyd_contacts' , 'shape_comp' , 'ddg_score', 'ddg_dsasa_100' , 'ddgscore_dsasa_100', 'cms', 'vbuns_bound', 'vbuns_unbound', 'vbuns_int', 'sbuns_bound', 'sbuns_unbound', 'sbuns_int']
...
with open(output_df, 'r+') as f:
    ...
    df.loc[df['model_path'] == input_pdb, metric_columns] = [ddg, rg, charge, sap, dG, interface_sasa, dG_dSASA_ratio, int_unsat_hbonds, int_hbonds, hyd_con , shape_comp , ddg_score, ddg_dsasa_100 , ddgscore_dsasa_100, cms, vbuns_bound, vbuns_unbound, vbuns_int, sbuns_bound, sbuns_unbound, sbuns_int]
