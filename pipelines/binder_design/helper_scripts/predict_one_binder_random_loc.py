...
parser.add_argument(
    "--designs_per_iteration",
    type=int,
    default=10,
    help="number of designs for further optimization (default: 10)",
)
parser.add_argument(
    "--proteinmpnn_per_input",
    type=int,
    default=5,
    help="proteinmpnn_per_input pdb in iteration (default: 5)",
)
parser.add_argument(
    "--sort_by",
    type=str,
    default="i_pae",
    help="score to sort during iteration (default: i_pae)",
)
...
for i in range(1, iterations + 1):
    ...
    for z, row in best_10.iterrows():
        if i == 1:
            mpnn_out = mpnn_seqs(
                ...
                "A",
                "B",
                proteinmpnn_per_input * designs_per_iteration,
            )
        else:
    ...
    plot_columns(
        df_plot,
        columns,
        save_path=f"{pdb_output}/{scaffold_basename}/iteration_plot.png",
    )
    try:
